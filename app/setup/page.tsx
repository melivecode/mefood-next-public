        ...
        >
          ...
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            <Typography variant="h4" component="h1" gutterBottom fontWeight={600}>
              {t('setup.welcome', 'Welcome to MeFood')}
            </Typography>
            <Typography variant="body1" color="text.secondary">
              {t('setup.subtitle', "Let's set up your restaurant management system")}
            </Typography>
          </Box>
          ...
          <Paper elevation={3} sx={{ p: 4, width: '100%' }}>
            <Box sx={{ textAlign: 'center', mb: 3 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                {t('setup.adminDescription', 'This will be the administrator account for your restaurant')}
              </Typography>
            </Box>
            ...
            <Box component="form" onSubmit={handleSubmit}>
              <Stack spacing={3}>
                ...
                <TextField
                  fullWidth
                  id="restaurantName"
                  label={t('setup.restaurantName', 'Restaurant Name')}
                  name="restaurantName"
                  value={restaurantName}
                  onChange={(e) => setRestaurantName(e.target.value)}
                  required
                  disabled={loading}
                  helperText={t('setup.restaurantNameHelper', 'You can change this later in settings')}
                />
                ...
                <TextField
                  ...
                  required
                  disabled={loading}
                  helperText={t('setup.passwordHelper', 'Minimum 6 characters')}
                  InputProps={{
                    endAdornment: (
                ...
                <Button
                  ...
                  sx={{ mt: 3, mb: 2 }}
                >
                  {loading ? t('setup.creating', 'Creating Account...') : t('setup.createButton', 'Create Account & Continue')}
                </Button>
              </Stack>
            </Box>
          </Paper>
